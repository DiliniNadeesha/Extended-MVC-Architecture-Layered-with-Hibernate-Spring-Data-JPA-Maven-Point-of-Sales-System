# Extended MVC Architecture(Layered) with Hibernate Spring Data JPA Maven Point of Sales System(POS)
...
You run this system, Database is auto generate with the system. Don't execute everything blindly.
